...
const encoderDiscountOptions: Array<{ label: string; value: number }> = [
  ...
  { label: 'P195', value: 195 },
  { label: 'P227', value: 227 },
  { label: 'P240', value: 240 },
  { label: 'P260', value: 260 },
  { label: 'P325', value: 325 },
  { label: 'P350', value: 350 },
  { label: 'P357', value: 357 },
  { label: 'P360', value: 360 },
  { label: '10% (P380)', value: 380 },
  { label: 'P390', value: 390 },
  { label: 'P450', value: 450 },
  { label: 'P480', value: 480 },
  { label: 'P500', value: 500 },
  { label: '20% (P760)', value: 760 },
  { label: 'P540', value: 540 },
  { label: 'P570', value: 570 },
  { label: 'P617', value: 617 },
  { label: 'P649', value: 649 },
  { label: 'P665', value: 665 },
  { label: 'P720', value: 720 },
  { label: 'P1748', value: 1748 },
  { label: 'P1045', value: 1045 },
  { label: 'P1140', value: 1140 },
  { label: 'P1260', value: 1260 },
  { label: '40% (P1,520)', value: 1520 },
  { label: 'P1620', value: 1620 },
  { label: 'P1680', value: 1680 },
  { label: '45% (P1,710)', value: 1710 },
  { label: 'P1800', value: 1800 },
  { label: 'P1805', value: 1805 },
  { label: '50% (P1,900)', value: 1900 },
  { label: 'P2160', value: 2160 },
  { label: 'P2400', value: 2400 },
  { label: '40% (P520)', value: 520 },
  { label: '45% (P585)', value: 585 },
  { label: '47.5% (P618)', value: 618 },
  { label: '50% (P650)', value: 650 },
